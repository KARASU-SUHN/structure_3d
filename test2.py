...
def check_overlap_2d(center, radius, particle_centers):
...
def generate_2d_figure():
    ...
    for _ in range(num_large_particles):
        while True:
            ...
            if not check_overlap_2d(center, large_radius, particle_centers):
    ...
    for _ in range(num_small_particles):
        while True:
            ...
            if not check_overlap_2d(center, small_radius, particle_centers):
